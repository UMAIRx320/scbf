...
for agenku in range(10000):
	a='Mozilla/5.0 (Linux; Android 11; Pixel 4a'
	b=random.choice(['8.1.0','9','10','11','12','13'])
	c='Build/RP1A.201005.006; wv)'
	d='AppleWebKit/537.36 (KHTML, like Gecko)'
	e=random.randrange(73,100)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
	i='Version/4.0 Chrome/86.0.4240.99 Mobile Safari/537.36'
	uakuh=f'{a} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
	usragent.append(uakuh)
	
	a='Mozilla/5.0 (Linux; U; Android 8.1.0; en-US; vivo 1807'
	b=random.choice(['8.1.0','9','10','11','12','13'])
	c='Build/OPM1.171019.026)'
	d='AppleWebKit/537.36 (KHTML, like Gecko)'
	e=random.randrange(73,100)
	f='0'
	g=random.randrange(4200,4900)
	h=random.randrange(40,150)
	i='Version/4.0 Chrome/99.0.4844.58 UCBrowser/11.4.8.1012 Mobile Safari/537.36'
	uakuh=f'{a} {b}; {c} {d}{e}.{f}.{g}.{h} {i}'
	usragent.append(uakuh)
